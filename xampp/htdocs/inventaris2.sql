...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 27, 2022 at 05:01 AM
...
('N.03.09.22.0002', '03', 'N', 'Canon', '2182j383j86gda', '2022-09-27', 'central komputer', 'barang baru beli', 'Jakarta'),
('O.01.09.22.0003', '01', 'O', 'asus', 'asu12712hddg3', '2022-09-27', 'central komputer', 'barang baru', 'Bangka Belitung');
...
INSERT INTO `service` (`kode_service`, `kode_barang`, `nama_barang`, `nama_pengguna`, `tgl_masuk`, `kerusakan`, `divisi`) VALUES
(1, 'N0509220003', 'Epson', 'dicky', '2022-09-26', 'tidka nyala', 'Logistik'),
(2, 'N0109220001', 'lenovo', 'kukuh', '2022-09-26', 'install windows', 'Hukum'),
(3, 'N0509220003', 'Epson', 'dodi', '2022-09-26', 'tidka nyala', 'Keuangan');
...
--
ALTER TABLE `service`
  MODIFY `kode_service` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
